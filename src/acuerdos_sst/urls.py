...
urlpatterns = [
    ...
    url(r'^(?P<company_slug>[-\w]+)/desactivar/(?P<agreement_pk>\d+)/$', views.desactive_agreement, name="desactive_agreement"),
    ...
    url(r'^(?P<company_slug>[-\w]+)/detalis/(?P<agreement_pk>\d+)/edit/(?P<agreement_detail_pk>\d+)/$', views.agreement_detail_edit, name="agreement_detail_edit"),
    url(r'^(?P<company_slug>[-\w]+)/detalis/(?P<agreement_pk>\d+)/delete/(?P<agreement_detail_pk>\d+)/$', views.agreement_detail_delete, name="agreement_detail_delete"),
]