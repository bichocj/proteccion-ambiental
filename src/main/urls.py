...
urlpatterns = patterns('main.views',
                       ...
                       url(r'^configuration/$', 'configuration_global', name='configuration_global'),
                       url(r'^configuration/requirement-new$', 'global_requirement_new', name='global_requirement_new'),
