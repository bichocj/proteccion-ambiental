...
urlpatterns = patterns('main.views',
                       ...
                       url(r'^(?P<company_slug>\w+)/accident-edit/(?P<accident_pk>\d+)/$', 'accident_edit', name='accident_edit'),
                       url(r'^(?P<company_slug>\w+)/accident-new/$', 'accident_new', name='accident_new'),
                       url(r'^(?P<company_slug>\w+)/accident-delete/(?P<accident_pk>\d+)/$', 'accident_delete', name='accident_delete'),
                       url(r'^(?P<company_slug>\w+)/requirements/$', 'requirements_list', name='requirements_list'),
                       url(r'^(?P<company_slug>\w+)/requirements/formats/(?P<requirement_pk>\d+)/$', 'format_list', name='format_list'),
                       url(r'^(?P<company_slug>\w+)/requirements/formats/new_pdf/(?P<requirement_pk>\d+)/$', 'format_new_pdf',
                           name='format_new_pdf'),
                       url(r'^(?P<company_slug>\w+)/requirements/formats/new_other/(?P<requirement_pk>\d+)/$', 'format_new_other',
