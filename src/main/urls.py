...
urlpatterns = [
    ...
    url(r'^config/requirement/(?P<requirement_pk>\d+)/formats/$', views.config_requirement_format_list, name='config_requirement_format_list'),
    url(r'^config/requirement/(?P<requirement_pk>\d+)/format/new/$',views.config_requirement_format_new,name='config_requirement_format_new'),
    url(r'^config/requirement/(?P<requirement_pk>\d+)/format/(?P<format_pk>\d+)/update/$',views.config_requirement_format_update, name='config_requirement_format_update'),
    ...
    url(r'^(?P<company_slug>[-\w]+)/requirement/(?P<requirement_pk>\d+)/formats/$', views.format_list, name='format_list'),

    url(r'^(?P<company_slug>[-\w]+)/requirement/(?P<requirement_pk>\d+)/format/(?P<format_pk>\d+)/update/',views.format_update, name='format_update'),
    url(r'^(?P<company_slug>[-\w]+)/requirement/(?P<requirement_pk>\d+)/format/new/$',views.format_new,name='format_new'),
    ...
    url(r'^(?P<company_slug>[-\w]+)/accident-delete/(?P<accident_pk>\d+)/$', views.accident_delete, name = 'accident_delete'),
