...
from .models import Company, Format, Accident, Requirement, LegalRequirement, MedicControl, Worker, \
...
class UserCompanyForm(UserCreationForm):
    ...
    group = forms.ChoiceField(choices=[(o.id, str(o)) for o in Group.objects.all()], label=_('group'))
